...
public class TFIDFModelBuilder implements Provider<TFIDFModel> {
    ...
    public TFIDFModel get() {
        ...
        //System.out.println(work.keySet());
        // Iterate over the items to compute each item's vector.
        //MutableSparseVector globalFrequencyVector = MutableSparseVector.create(tagIds.values());
        ...
        for (long item: items) {
            ...
            //System.out.println(work.shrinkDomain());
...
//        System.out.println(modelData.values());
